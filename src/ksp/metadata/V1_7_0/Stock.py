...
PARTS_BY_CATEGORY = {
	'*DEPRECATED*': set([
		'RCSBlock', 'Size3to2Adapter', 'liquidEngine2-2', 'liquidEngine3', 'liquidEngineMini', 'microEngine', 'mk1pod', 'mk2LanderCabin', 'probeCoreHex', 'probeCoreOcto'
		'probeCoreOcto2', 'probeCoreSphere', 'radialEngineMini', 'rocketNoseCone', 'roverBody', 'smallRadialEngine', 'solidBooster', 'solidBooster_sm', 'stackBiCoupler', 'stackTriCoupler'
	]),
	'*UNSORTED*': set([
	...
	'Engine': set([
		...
		'liquidEngine1-2', 'liquidEngine2', 'liquidEngine2-2_v2', 'liquidEngine3_v2', 'liquidEngineMini_v2', 'microEngine_v2', 'miniJetEngine', 'nuclearEngine', 'omsEngine', 'radialEngineMini_v2'
		'radialLiquidEngine1-2', 'sepMotor1', 'smallRadialEngine_v2', 'solidBooster1-1', 'solidBooster_sm_v2', 'solidBooster_v2', 'toroidalAerospike', 'turboFanEngine', 'turboFanSize2', 'turboJet'
	]),
	'FuelTank': set([
