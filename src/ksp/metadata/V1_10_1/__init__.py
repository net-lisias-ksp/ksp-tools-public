...
import ksp.metadata.V1_10_1.Stock as Stock
import ksp.metadata.V1_10_1.MakingHistory as MH
import ksp.metadata.V1_10_1.Serenity as Serenity

ALL_MODULES = Stock.MODULES | MH.MODULES | Serenity.MODULES

RELEASE_DATETIME=datetime(2020, 7, 28, 0, 0)
UNITY_VERSION=2019
CSHARP_VERSION=4.7
