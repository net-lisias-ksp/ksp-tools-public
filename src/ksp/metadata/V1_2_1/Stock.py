...
PARTS_BY_CATEGORY = {
	...
	'Science': set([
		'GooExperiment', 'Large_Crewed_Lab', 'OrbitalScanner', 'ScienceBox', 'SurfaceScanner', 'SurveyScanner', 'science_module', 'sensorAccelerometer', 'sensorAtmosphere', 'sensorBarometer'
		'sensorGravimeter', 'sensorThermometer'
	]),
	'Structural': set([
