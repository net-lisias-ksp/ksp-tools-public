...
PARTS_BY_CATEGORY = {
	...
	'Aero': set([
		...
		'airScoop', 'airbrake1', 'airlinerCtrlSrf', 'airlinerMainWing', 'airlinerTailFin', 'airplaneTail', 'airplaneTailB', 'basicFin', 'deltaWing', 'delta_small'
		'elevon2', 'elevon3', 'elevon5', 'fairingSize1', 'fairingSize2', 'fairingSize3', 'miniIntake', 'nacelleBody', 'noseCone', 'pointyNoseConeA'
		'pointyNoseConeB', 'radialEngineBody', 'ramAirIntake', 'rocketNoseCone', 'shockConeIntake', 'smallCtrlSrf', 'standardNoseCone', 'structuralWing', 'structuralWing2', 'structuralWing3'
		'structuralWing4', 'sweptWing', 'sweptWing1', 'sweptWing2', 'tailfin', 'wingConnector', 'wingConnector2', 'wingConnector3', 'wingConnector4', 'wingConnector5'
		'wingShuttleDelta', 'wingShuttleElevon1', 'wingShuttleElevon2', 'wingShuttleRudder', 'wingShuttleStrake', 'wingStrake', 'winglet', 'winglet3'
	]),
	'Control': set([
	...
	'Utility': set([
		'FuelCell', 'FuelCellArray', 'GearFixed', 'GearFree', 'GearLarge', 'GearMedium', 'GrapplingDevice', 'ISRU', 'LaunchEscapeSystem', 'MK1CrewCabin'
		'MiniDrill', 'MiniISRU', 'RadialDrill', 'ServiceBay_125', 'ServiceBay_250', 'SmallGearBay', 'batteryBank', 'batteryBankLarge', 'batteryBankMini', 'batteryPack'
		'crewCabin', 'dockingPort1', 'dockingPort2', 'dockingPort3', 'dockingPortLarge', 'dockingPortLateral', 'foldingRadLarge', 'foldingRadMed', 'foldingRadSmall', 'ksp_r_largeBatteryPack'
		'ladder1', 'landingLeg1', 'landingLeg1-2', 'largeSolarPanel', 'miniLandingLeg', 'mk2CargoBayL', 'mk2CargoBayS', 'mk2CrewCabin', 'mk2DockingPort', 'mk3CargoBayL'
		'mk3CargoBayM', 'mk3CargoBayS', 'mk3CargoRamp', 'mk3CrewCabin', 'parachuteDrogue', 'parachuteLarge', 'parachuteRadial', 'parachuteSingle', 'radPanelEdge', 'radPanelLg'
		'radPanelSm', 'radialDrogue', 'roverWheel1', 'roverWheel2', 'roverWheel3', 'rtg', 'solarPanels1', 'solarPanels2', 'solarPanels3', 'solarPanels4'
