...
PARTS_BY_CATEGORY = {
	...
	'Utility': set([
		'ISRU', 'LaunchEscapeSystem', 'MK1CrewCabin', 'MiniDrill', 'MiniISRU', 'RadialDrill', 'crewCabin', 'flagPartFlat', 'flagPartSize0', 'flagPartSize1'
		'flagPartSize2', 'flagPartSize3', 'ladder1', 'mk2CrewCabin', 'mk3CrewCabin', 'parachuteDrogue', 'parachuteLarge', 'parachuteRadial', 'parachuteSingle', 'radialDrogue'
		'spotLight1', 'spotLight2', 'telescopicLadder', 'telescopicLadderBay'
	]),
}
