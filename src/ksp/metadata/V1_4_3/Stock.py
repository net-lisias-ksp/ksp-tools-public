...
PARTS_BY_CATEGORY = {
	'*DEPRECATED*': set([
		'Mark1-2Pod', 'decoupler1-2', 'fuelTank1-2', 'fuelTank2-2', 'fuelTank3-2', 'fuelTank4-2', 'size3Decoupler', 'stackDecoupler', 'stackDecouplerMini', 'stackSeparator'
		'stackSeparatorBig', 'stackSeparatorMini', 'toroidalFuelTank'
	]),
	'*UNSORTED*': set([
	...
	'Pods': set([
		'HECS2_ProbeCore', 'Mark1Cockpit', 'Mark2Cockpit', 'cupola', 'landerCabinSmall', 'mk1-3pod', 'mk1pod', 'mk2Cockpit_Inline', 'mk2Cockpit_Standard', 'mk2DroneCore'
