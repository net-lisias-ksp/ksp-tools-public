...
PARTS_BY_CATEGORY = {
	...
	'Aero': set([
		...
		'elevon2', 'elevon3', 'elevon5', 'fairingSize1', 'fairingSize2', 'fairingSize3', 'nacelleBody', 'noseCone', 'pointyNoseConeA', 'pointyNoseConeB'
		'radialEngineBody', 'ramAirIntake', 'rocketNoseCone', 'shockConeIntake', 'smallCtrlSrf', 'standardNoseCone', 'structuralWing', 'structuralWing2', 'structuralWing3', 'structuralWing4'
		'sweptWing', 'sweptWing1', 'sweptWing2', 'tailfin', 'wingConnector', 'wingConnector2', 'wingConnector3', 'wingConnector4', 'wingConnector5', 'wingShuttleDelta'
		'wingShuttleElevon1', 'wingShuttleElevon2', 'wingShuttleRudder', 'wingShuttleStrake', 'wingStrake', 'winglet', 'winglet3'
	]),
	'Control': set([
	...
	'Utility': set([
		...
		'dockingPort3', 'dockingPortLarge', 'dockingPortLateral', 'foldingRadLarge', 'foldingRadMed', 'foldingRadSmall', 'ksp_r_largeBatteryPack', 'ladder1', 'landingLeg1', 'landingLeg1-2'
		'largeSolarPanel', 'miniLandingLeg', 'mk2CargoBayL', 'mk2CargoBayS', 'mk2CrewCabin', 'mk2DockingPort', 'mk3CargoBayL', 'mk3CargoBayM', 'mk3CargoBayS', 'mk3CrewCabin'
		'parachuteDrogue', 'parachuteLarge', 'parachuteRadial', 'parachuteSingle', 'radPanelLg', 'radPanelSm', 'radialDrogue', 'roverWheel1', 'roverWheel2', 'roverWheel3'
		'rtg', 'solarPanels1', 'solarPanels2', 'solarPanels3', 'solarPanels4', 'solarPanels5', 'spotLight1', 'spotLight2', 'telescopicLadder', 'telescopicLadderBay'
		'wheelMed'
	]),
}
