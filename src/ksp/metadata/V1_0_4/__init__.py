...
import ksp.metadata.V1_0_4.Stock as Stock
import ksp.metadata.V1_0_4.MakingHistory as MH
import ksp.metadata.V1_0_4.Serenity as Serenity

ALL_MODULES = Stock.MODULES | MH.MODULES | Serenity.MODULES

RELEASE_DATETIME=datetime(2015, 6, 23, 0, 0)
UNITY_VERSION=4
CSHARP_VERSION=3.5
