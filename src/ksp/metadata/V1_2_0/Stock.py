...
PARTS = set([
	...
	'InflatableHeatShield', 'IntakeRadialLong', 'JetEngine', 'LargeTank', 'Large_Crewed_Lab', 'LaunchEscapeSystem', 'LgRadialSolarPanel', 'MK1CrewCabin', 'MK1Fuselage', 'MK1IntakeFuselage'
	'Mark1-2Pod', 'Mark1Cockpit', 'Mark2Cockpit', 'MassiveBooster', 'MiniDrill', 'MiniISRU', 'Mk1FuselageStructural', 'OrbitalScanner', 'PotatoRoid', 'R8winglet'
	'RAPIER', 'RCSBlock', 'RCSFuelTank', 'RCSTank1-2', 'RadialDrill', 'RadialOreTank', 'RelayAntenna100', 'RelayAntenna5', 'RelayAntenna50', 'SSME'
	'ScienceBox', 'ServiceBay_125', 'ServiceBay_250', 'Size2LFB', 'Size3AdvancedEngine', 'Size3EngineCluster', 'Size3LargeTank', 'Size3MediumTank', 'Size3SmallTank', 'Size3to2Adapter'
	'SmallGearBay', 'SmallTank', 'StandardCtrlSrf', 'SurfAntenna', 'SurfaceScanner', 'SurveyScanner', 'adapterEngines', 'adapterLargeSmallBi', 'adapterLargeSmallQuad', 'adapterLargeSmallTri'
	...
	'batteryBank', 'batteryBankLarge', 'batteryBankMini', 'batteryPack', 'commDish', 'crewCabin', 'cupola', 'decoupler1-2', 'deltaWing', 'delta_small'
	'dockingPort1', 'dockingPort2', 'dockingPort3', 'dockingPortLarge', 'dockingPortLateral', 'elevon2', 'elevon3', 'elevon5', 'engineLargeSkipper', 'fairingSize1'
	'fairingSize2', 'fairingSize3', 'flag', 'foldingRadLarge', 'foldingRadMed', 'foldingRadSmall', 'fuelLine', 'fuelTank', 'fuelTank1-2', 'fuelTank2-2'
	'fuelTank3-2', 'fuelTank4-2', 'fuelTankSmall', 'fuelTankSmallFlat', 'fuelTank_long', 'ionEngine', 'kerbalEVA', 'kerbalEVAfemale', 'ksp_r_largeBatteryPack', 'ladder1'
