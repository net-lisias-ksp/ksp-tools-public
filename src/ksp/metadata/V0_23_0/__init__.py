...
import ksp.metadata.V0_23_0.Stock as Stock
import ksp.metadata.V0_23_0.MakingHistory as MH
import ksp.metadata.V0_23_0.Serenity as Serenity

ALL_MODULES = Stock.MODULES | MH.MODULES | Serenity.MODULES
ALL_PARTS = Stock.PARTS | MH.PARTS | Serenity.PARTS

RELEASE_DATETIME=datetime(2013, 12, 17, 0, 0)
UNITY_VERSION=4
CSHARP_VERSION=3.5
