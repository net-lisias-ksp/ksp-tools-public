...
PARTS_BY_CATEGORY = {
	'*DEPRECATED*': set([
		'RCSBlock', 'ServiceBay_125', 'ServiceBay_250', 'Size3to2Adapter', 'liquidEngine2-2', 'liquidEngine3', 'liquidEngineMini', 'microEngine', 'mk1pod', 'mk2LanderCabin'
		'probeCoreHex', 'probeCoreOcto', 'probeCoreOcto2', 'probeCoreSphere', 'radialEngineMini', 'rocketNoseCone', 'roverBody', 'smallRadialEngine', 'solidBooster', 'solidBooster_sm'
		'stackBiCoupler', 'stackTriCoupler'
	]),
	'*UNSORTED*': set([
	...
	'Engine': set([
		...
		'Thoroughbred', 'engineLargeSkipper', 'ionEngine', 'liquidEngine', 'liquidEngine1-2', 'liquidEngine2', 'liquidEngine2-2_v2', 'liquidEngine3_v2', 'liquidEngineMini_v2', 'microEngine_v2'
