...
PARTS_BY_CATEGORY = {
	...
	'Propulsion': set([
		...
		'liquidEngineMini', 'microEngine', 'miniFuelTank', 'mk2Fuselage', 'mk2SpacePlaneAdapter', 'mk3Fuselage', 'mk3spacePlaneAdapter', 'nuclearEngine', 'omsEngine', 'radialEngineMini'
		'radialLiquidEngine1-2', 'radialRCSTank', 'rcsTankMini', 'rcsTankRadialLong', 'sepMotor1', 'smallRadialEngine', 'solidBooster', 'solidBooster1-1', 'toroidalAerospike', 'toroidalFuelTank'
		'turboFanEngine'
	]),
	'Science': set([
