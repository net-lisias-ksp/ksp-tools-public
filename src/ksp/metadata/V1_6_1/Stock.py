...
PARTS_BY_CATEGORY = {
	'*DEPRECATED*': set([
		'Mark1-2Pod', 'Size3to2Adapter', 'decoupler1-2', 'fuelTank1-2', 'fuelTank2-2', 'fuelTank3-2', 'fuelTank4-2', 'liquidEngine2-2', 'liquidEngine3', 'liquidEngineMini'
		'mk1pod', 'mk2LanderCabin', 'probeCoreHex', 'probeCoreOcto', 'probeCoreOcto2', 'probeCoreSphere', 'rocketNoseCone', 'roverBody', 'size3Decoupler', 'solidBooster'
		'solidBooster_sm', 'stackBiCoupler', 'stackDecoupler', 'stackDecouplerMini', 'stackSeparator', 'stackSeparatorBig', 'stackSeparatorMini', 'stackTriCoupler', 'toroidalFuelTank'
	]),
	'*UNSORTED*': set([
	...
	'Aero': set([
		...
		'miniIntake', 'nacelleBody', 'noseCone', 'pointyNoseConeA', 'pointyNoseConeB', 'radialEngineBody', 'ramAirIntake', 'rocketNoseCone_v2', 'shockConeIntake', 'smallCtrlSrf'
	...
	'Engine': set([
		'JetEngine', 'MassiveBooster', 'RAPIER', 'SSME', 'Size2LFB', 'Size3AdvancedEngine', 'Size3EngineCluster', 'engineLargeSkipper', 'ionEngine', 'liquidEngine'
		'liquidEngine1-2', 'liquidEngine2', 'liquidEngine2-2_v2', 'liquidEngine3_v2', 'liquidEngineMini_v2', 'microEngine', 'miniJetEngine', 'nuclearEngine', 'omsEngine', 'radialEngineMini'
		'radialLiquidEngine1-2', 'sepMotor1', 'smallRadialEngine', 'solidBooster1-1', 'solidBooster_sm_v2', 'solidBooster_v2', 'toroidalAerospike', 'turboFanEngine', 'turboFanSize2', 'turboJet'
	]),
	'FuelTank': set([
		'LargeTank', 'MK1Fuselage', 'RCSFuelTank', 'RCSTank1-2', 'RadialOreTank', 'Rockomax16_BW', 'Rockomax32_BW', 'Rockomax64_BW', 'Rockomax8BW', 'Size3To2Adapter_v2'
		'SmallTank', 'adapterMk3-Mk2', 'adapterMk3-Size2', 'adapterMk3-Size2Slant', 'adapterSize2-Mk2', 'adapterSize2-Size1', 'adapterSize2-Size1Slant', 'adapterSize3-Mk3', 'externalTankToroid', 'fuelLine'
		'fuelTank', 'fuelTankSmall', 'fuelTankSmallFlat', 'fuelTank_long', 'miniFuelTank', 'mk3FuselageLFO_100', 'mk3FuselageLFO_25', 'mk3FuselageLFO_50', 'mk3FuselageLF_100', 'mk3FuselageLF_25'
		'mk3FuselageLF_50', 'mk3FuselageMONO', 'radialRCSTank', 'rcsTankMini', 'rcsTankRadialLong', 'xenonTank', 'xenonTankLarge', 'xenonTankRadial'
	]),
	'Ground': set([
