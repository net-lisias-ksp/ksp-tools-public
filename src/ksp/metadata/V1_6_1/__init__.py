...
import ksp.metadata.V1_6_1.Stock as Stock
import ksp.metadata.V1_6_1.MakingHistory as MH
import ksp.metadata.V1_6_1.Serenity as Serenity

ALL_MODULES = Stock.MODULES | MH.MODULES | Serenity.MODULES

RELEASE_DATETIME=datetime(2019, 1, 9, 0, 0)
UNITY_VERSION=2017
CSHARP_VERSION=3.5
