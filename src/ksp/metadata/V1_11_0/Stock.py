...
PARTS_BY_CATEGORY = {
	'*DEPRECATED*': set([
		'HighGainAntenna5', 'RCSBlock', 'ServiceBay_125', 'ServiceBay_250', 'Size2LFB', 'Size3to2Adapter', 'engineLargeSkipper', 'liquidEngine1-2', 'liquidEngine2-2', 'liquidEngine3'
		'liquidEngineMini', 'microEngine', 'mk1pod', 'mk2LanderCabin', 'probeCoreHex', 'probeCoreOcto', 'probeCoreOcto2', 'probeCoreSphere', 'radialEngineMini', 'rocketNoseCone'
		'roverBody', 'smallRadialEngine', 'solidBooster', 'solidBooster_sm', 'stackBiCoupler', 'stackTriCoupler'
	]),
	'*UNSORTED*': set([
		'PotatoComet', 'PotatoRoid', 'flag', 'kerbalEVA', 'kerbalEVAfemale'
	]),
	'Aero': set([
	...
	'Cargo': set([
		'CargoStorageUnit', 'ConformalStorageUnit', 'cargoContainer', 'evaChute', 'evaCylinder', 'evaJetpack', 'evaRepairKit', 'evaScienceKit', 'groundLight1', 'groundLight2'
		'smallCargoContainer'
	]),
	'Communication': set([
		'HighGainAntenna', 'HighGainAntenna5_v2', 'RelayAntenna100', 'RelayAntenna5', 'RelayAntenna50', 'SurfAntenna', 'commDish', 'longAntenna', 'mediumDishAntenna'
	]),
	'Control': set([
		'RCSBlock_v2', 'RCSLinearSmall', 'RCSblock_01_small', 'advSasModule', 'asasmodule1-2', 'avionicsNoseCone', 'linearRcs', 'sasModule', 'vernierEngine'
	]),
	'Coupling': set([
		...
		'dockingPort2', 'dockingPort3', 'dockingPortLarge', 'dockingPortLateral', 'mk2DockingPort', 'radialDecoupler', 'radialDecoupler1-2', 'radialDecoupler2', 'smallClaw'
	]),
	'Electrical': set([
	...
	'Engine': set([
		'Clydesdale', 'JetEngine', 'MassiveBooster', 'Mite', 'RAPIER', 'SSME', 'Shrimp', 'Size2LFB_v2', 'Size3AdvancedEngine', 'Size3EngineCluster'
	...
	'Pods': set([
		'HECS2_ProbeCore', 'Mark1Cockpit', 'Mark2Cockpit', 'MpoProbe', 'MtmStage', 'cupola', 'landerCabinSmall', 'mk1-3pod', 'mk1pod_v2', 'mk2Cockpit_Inline'
		'mk2Cockpit_Standard', 'mk2DroneCore', 'mk2LanderCabin_v2', 'mk3Cockpit_Shuttle', 'probeCoreCube', 'probeCoreHex_v2', 'probeCoreOcto2_v2', 'probeCoreOcto_v2', 'probeCoreSphere_v2', 'probeStackLarge'
		'probeStackSmall', 'roverBody_v2', 'seatExternalCmd'
	]),
	'Propulsion': set([
	...
	'Science': set([
		'GooExperiment', 'InfraredTelescope', 'Large_Crewed_Lab', 'Magnetometer', 'OrbitalScanner', 'ScienceBox', 'SurfaceScanner', 'SurveyScanner', 'science_module', 'sensorAccelerometer'
	...
	'Utility': set([
		'ISRU', 'LaunchEscapeSystem', 'MK1CrewCabin', 'MiniDrill', 'MiniISRU', 'RadialDrill', 'crewCabin', 'domeLight1', 'flagPartFlat', 'flagPartSize0'
		'flagPartSize1', 'flagPartSize2', 'flagPartSize3', 'ladder1', 'mk2CrewCabin', 'mk3CrewCabin', 'navLight1', 'parachuteDrogue', 'parachuteLarge', 'parachuteRadial'
		'parachuteSingle', 'radialDrogue', 'spotLight1', 'spotLight2', 'spotLight3', 'stripLight1', 'telescopicLadder', 'telescopicLadderBay'
	]),
}
