...
PARTS_BY_CATEGORY = {
	...
	'Engine': set([
		'LiquidEngineKE-1', 'LiquidEngineLV-T91', 'LiquidEngineLV-TX87', 'LiquidEngineRE-I2', 'LiquidEngineRE-J10', 'LiquidEngineRK-7', 'LiquidEngineRV-1', 'Pollux'
	]),
	'FuelTank': set([
