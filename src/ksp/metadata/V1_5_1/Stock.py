...
PARTS_BY_CATEGORY = {
	'*DEPRECATED*': set([
		'Mark1-2Pod', 'decoupler1-2', 'fuelTank1-2', 'fuelTank2-2', 'fuelTank3-2', 'fuelTank4-2', 'mk1pod', 'probeCoreHex', 'probeCoreOcto', 'probeCoreOcto2'
		'probeCoreSphere', 'roverBody', 'size3Decoupler', 'solidBooster', 'solidBooster_sm', 'stackDecoupler', 'stackDecouplerMini', 'stackSeparator', 'stackSeparatorBig', 'stackSeparatorMini'
		'toroidalFuelTank'
	]),
	'*UNSORTED*': set([
	...
	'Engine': set([
		...
		'microEngine', 'miniJetEngine', 'nuclearEngine', 'omsEngine', 'radialEngineMini', 'radialLiquidEngine1-2', 'sepMotor1', 'smallRadialEngine', 'solidBooster1-1', 'solidBooster_sm_v2'
		'solidBooster_v2', 'toroidalAerospike', 'turboFanEngine', 'turboFanSize2', 'turboJet'
	]),
	'FuelTank': set([
		'LargeTank', 'MK1Fuselage', 'RCSFuelTank', 'RCSTank1-2', 'RadialOreTank', 'Rockomax16_BW', 'Rockomax32_BW', 'Rockomax64_BW', 'Rockomax8BW', 'SmallTank'
		'adapterMk3-Mk2', 'adapterMk3-Size2', 'adapterMk3-Size2Slant', 'adapterSize2-Mk2', 'adapterSize2-Size1', 'adapterSize2-Size1Slant', 'adapterSize3-Mk3', 'externalTankToroid', 'fuelLine', 'fuelTank'
		'fuelTankSmall', 'fuelTankSmallFlat', 'fuelTank_long', 'miniFuelTank', 'mk3FuselageLFO_100', 'mk3FuselageLFO_25', 'mk3FuselageLFO_50', 'mk3FuselageLF_100', 'mk3FuselageLF_25', 'mk3FuselageLF_50'
		'mk3FuselageMONO', 'radialRCSTank', 'rcsTankMini', 'rcsTankRadialLong', 'xenonTank', 'xenonTankLarge', 'xenonTankRadial'
	]),
	'Ground': set([
	...
	'Pods': set([
		...
		'mk2LanderCabin', 'mk3Cockpit_Shuttle', 'probeCoreCube', 'probeCoreHex_v2', 'probeCoreOcto2_v2', 'probeCoreOcto_v2', 'probeCoreSphere_v2', 'probeStackLarge', 'probeStackSmall', 'roverBody_v2'
		'seatExternalCmd'
	]),
	'Propulsion': set([
		'MassiveBooster', 'SSME', 'Size2LFB', 'Size3AdvancedEngine', 'Size3EngineCluster', 'Size3LargeTank', 'Size3MediumTank', 'Size3SmallTank', 'externalTankCapsule', 'externalTankRound'
		'miniFuselage', 'mk2Fuselage', 'mk2FuselageLongLFO', 'mk2FuselageShortLFO', 'mk2FuselageShortLiquid', 'mk2FuselageShortMono', 'mk2SpacePlaneAdapter', 'mk2_1m_AdapterLong', 'mk2_1m_Bicoupler', 'noseConeAdapter'
	]),
	'Science': set([
