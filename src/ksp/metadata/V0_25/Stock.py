...
PARTS_BY_CATEGORY = {
	...
	'Propulsion': set([
		...
		'fuelTank3-2', 'fuelTank4-2', 'fuelTankSmall', 'fuelTankSmallFlat', 'fuelTank_long', 'ionEngine', 'liquidEngine', 'liquidEngine1-2', 'liquidEngine2', 'liquidEngine2-2'
		'liquidEngine3', 'liquidEngineMini', 'microEngine', 'miniFuelTank', 'mk3Fuselage', 'mk3spacePlaneAdapter', 'nuclearEngine', 'omsEngine', 'radialEngineMini', 'radialLiquidEngine1-2'
	...
	'Utility': set([
		...
		'dockingPortLateral', 'ksp_r_largeBatteryPack', 'ladder1', 'landingLeg1', 'landingLeg1-2', 'largeSolarPanel', 'miniLandingLeg', 'parachuteDrogue', 'parachuteLarge', 'parachuteRadial'
		'parachuteSingle', 'roverWheel1', 'roverWheel2', 'roverWheel3', 'rtg', 'solarPanels1', 'solarPanels2', 'solarPanels3', 'solarPanels4', 'solarPanels5'
		'spotLight1', 'spotLight2', 'telescopicLadder', 'telescopicLadderBay', 'wheelMed'
	]),
}
