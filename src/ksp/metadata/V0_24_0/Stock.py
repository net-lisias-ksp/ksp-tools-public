...
PARTS = set([
	...
	'mk3spacePlaneAdapter', 'nacelleBody', 'noseCone', 'noseConeAdapter', 'nuclearEngine', 'omsEngine', 'parachuteDrogue', 'parachuteLarge', 'parachuteRadial', 'parachuteSingle'
	'probeCoreCube', 'probeCoreHex', 'probeCoreOcto', 'probeCoreOcto2', 'probeCoreSphere', 'probeStackLarge', 'probeStackSmall', 'radialDecoupler', 'radialDecoupler1-2', 'radialDecoupler2'
	'radialEngineBody', 'radialEngineMini', 'radialLiquidEngine1-2', 'radialRCSTank', 'ramAirIntake', 'rcsTankMini', 'rcsTankRadialLong', 'rocketNoseCone', 'roverBody', 'roverWheel1'
	'roverWheel2', 'roverWheel3', 'rtg', 'sasModule', 'science_module', 'seatExternalCmd', 'sensorAccelerometer', 'sensorBarometer', 'sensorGravimeter', 'sensorThermometer'
	'sepMotor1', 'smallCtrlSrf', 'smallHardpoint', 'smallRadialEngine', 'solarPanels1', 'solarPanels2', 'solarPanels3', 'solarPanels4', 'solarPanels5', 'solidBooster'
	'solidBooster1-1', 'spotLight1', 'spotLight2', 'stackBiCoupler', 'stackDecoupler', 'stackDecouplerMini', 'stackPoint1', 'stackQuadCoupler', 'stackSeparator', 'stackSeparatorBig'
	...
	'structuralPylon', 'structuralWing', 'strutConnector', 'strutCube', 'strutOcto', 'sweptWing', 'tailfin', 'telescopicLadder', 'telescopicLadderBay', 'toroidalAerospike'
	'toroidalFuelTank', 'trussAdapter', 'trussPiece1x', 'trussPiece3x', 'turboFanEngine', 'vernierEngine', 'wheelMed', 'wingConnector', 'winglet', 'winglet3'
